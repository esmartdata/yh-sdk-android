        ...
        try {
            ...
            if (getParentFragmentMethod != null) {
                ...
                if (parentFragment == null) {
                    ...
                    Log.i(TAG, "setFragmentScreenName | " + fragmentScreenName + " is not nested fragment and set");
                } else {
                    Log.i(TAG, "setFragmentScreenName | " + fragmentScreenName + " is nested fragment and ignored");
                }
            }
        } catch (Exception e) {
            //ignored
